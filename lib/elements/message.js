...
export default class Message extends DiagramElement {
    ...
    createObjects() {
        ...
        this.arrowTip = new fabric.Triangle({
            originX: 'center',     // set the origin to the center of the triangle. This will help in centering the triangle on the line end.
            originY: 'center', 
            width: 20,
            height: 20,
            fill: 'black',
    ...
    updatePositions() {
        ...
        this.position2 = { 
          x: this.position1.x + this.line.width * this.line.scaleX * Math.cos(this.line.angle * Math.PI / 180), 
          y: this.position1.y + this.line.width * this.line.scaleX * Math.sin(this.line.angle * Math.PI / 180)
        };
      
        // Update the text position
        this.text.set({
            left: this.position1.x - this.text.width/2 + this.line.width * this.line.scaleX/2,
